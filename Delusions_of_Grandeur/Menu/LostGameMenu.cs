...
public class LostGameMenu
{
    ...
    public LostGameMenu(AssetManager assetManager, InputManager inputManager, GraphicsDevice graphics, StatisticMenu statisticMenu)
    {
        _buttons = [];
        _inputManager = inputManager;
        _graphics = graphics;
        assetManager.GetMusic("lostgamemusic");
        _buttons =
        [
        ...
        _background = assetManager.GetTexture("lostgame");
    }
    ...
    public void Draw(SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.Draw(_buttonBackground, new Rectangle(0, 0, 1920, 1080), new Color(Color.Black, 0.5f));
